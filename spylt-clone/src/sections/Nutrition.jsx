        ...
        <div className='flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0'>
            ...
            <div className='flex md:justify-center items-center translate-y-5'>
                <div className='md:max-w-xs max-w-md '>
                    <p className='text-lg md:text-right text-balance font-paragraph'>Milk contains a wide array of nutrients, including vitamins,
                    ...
                    {   lists.map((nutrient, idx) =>(
                            <div key={idx} className='relative flex-1 col-center'>
                                <div>
                                    ...
                                    <p className='text-sm font-paragraph mt-2 mb-1'>up to</p>
